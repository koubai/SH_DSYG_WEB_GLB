...
<script type="text/javascript">
	function upd() {
		if(checkData()) {
			if(confirm("确定修改吗？")) {
				document.mainform.action = '<c:url value="/recruit/updRecruitAction.action"></c:url>';
		...
		<div class="content warehouse_input">
			...
			<div class="main_body">
				<s:form id="mainform" name="mainform" method="POST" enctype="multipart/form-data">
					<s:hidden name="updRecruitDto.data" id="data"></s:hidden>
					...
					<table class="input_table" border="0" cellspacing="0" cellpadding="10">
						<tr>
							...
							<td>
								<s:textfield name="updRecruitDto.title" id="title" cssStyle="width:300px;" maxlength="64" theme="simple"></s:textfield>
							</td>
						</tr>
						<tr>
							<td class="td_tittle"><span>*</span>招聘人数：</td>
							<td>
								<s:textfield name="updRecruitDto.persons" id="persons" cssStyle="width:300px;" maxlength="10" theme="simple"></s:textfield>
							</td>
						</tr>
						<tr>
							<td class="td_tittle"><span>*</span>内容：</td>
							<td>
								<textarea rows="10" cols="50" style="width:300px;" id="tempData"><s:property value="updRecruitDto.data"/></textarea>
							</td>
						</tr>
						<tr>
							<td></td>
