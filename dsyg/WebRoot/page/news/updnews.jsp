				...
				<s:form id="mainform" name="mainform" method="POST" enctype="multipart/form-data">
					...
					<table class="input_table" border="0" cellspacing="0" cellpadding="10">
						...
						<tr>
							...
							<td>
								<s:textfield name="updNewsDto.res01" id="title" cssStyle="width:500px;" maxlength="300" theme="simple"></s:textfield>
							</td>
						</tr>
						<tr>
						<tr>
							...
							<td>
								<s:textfield name="updNewsDto.res02" id="title" cssStyle="width:500px;" maxlength="300" theme="simple"></s:textfield>
							</td>
						</tr>
						<tr>
							<td></td>
