...
public class QaServiceImpl implements QaService {
	...
	public Page queryQaByPage(String title, String company, String tell,
		...
		//查询总记录数，这里只查询状态=1的
		int totalCount = qaDao.queryQaCountByPage(title, company, tell, "" + Constants.STATUS_NORMAL);
		...
		//翻页查询记录，这里只查询状态=1的
		List<QaDto> list = qaDao.queryQaByPage(title, company, tell, "" + Constants.STATUS_NORMAL,
